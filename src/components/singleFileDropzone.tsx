...
const variants = {
  base: "border flex h-[280px] w-[373px] flex-col items-center justify-center gap-2 rounded-2xl border-gray-200 bg-white p-1.5",
  image: "",
  active: "",
  disabled: "",
  accept: "",
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center">
              <p className="text-lg font-bold">
                Upload {label} or{" "}
                <span className="cursor-pointer text-primaryDark">Browse</span>
              </p>
